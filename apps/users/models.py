...
class EmailVerifyRecord(models.Model):
    ...
    send_time = models.DateTimeField(verbose_name=u"发送时间", default=datetime.now)#datetime.now()编译时间 datetime.now() .class文件执行时间
